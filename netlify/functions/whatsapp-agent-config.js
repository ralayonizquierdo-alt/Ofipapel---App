...
const RECOGIDA_TIENDA_INFO = `Sí, al hacer tu pedido en la web, en el paso de "Finalizar Compra" puedes elegir "Recogida en tienda" en vez de envío a domicilio — resulta más cómodo y rápido pasar a por él, aunque tu pedido ya tenga el envío gratis.`;
