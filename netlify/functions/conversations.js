...
// El panel usa Basic Auth: el navegador reenvía la cabecera Authorization
// automáticamente en cualquier petición al mismo origen una vez el admin ha
// iniciado sesión en él, incluida una que dispare una página maliciosa desde
// otra pestaña (CSRF) — un formulario oculto ahí podría borrar el historial
// de un cliente o mandar mensajes en nombre del negocio sin que el admin
// haga nada. Como defensa, en las acciones que cambian estado (POST) se
// exige que el Origin (o, si el navegador no lo manda, el Referer) de la
// petición coincida con el propio sitio.
