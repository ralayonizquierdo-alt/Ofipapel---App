...
- Para tareas de diseño visual (marcas Ofipapel, Canarias INK, FalControl,
  etc.), esta Skill no diseña: delega a `diseno-ofipapel` una vez migrada
  (ver estado en el registro); mientras no lo esté, dilo explícitamente en
  vez de improvisar una solución de diseño.
