...
| [`diseno-ofipapel`](./diseno-ofipapel/SKILL.md) | Diseño visual de marca (banners, posts, flyers, material promocional) para Ofipapel, Canarias INK y FalControl, reutilizando `design-studio/` | ✅ Activa |
...
tenga al menos una campaña real entregada y usada por el negocio. El código
sigue disponible en esa rama (que se conserva, no se borra) por si se
decide retomarlo más adelante. Sí se rescató de esa rama el formato de
`project-manager/references/cola-prioridades.md`, que no depende de ningún
dato de marca.
