// Biblioteca atómica: ILUMINACIÓN.

module.exports = [
  { id: 'golden-hour', label: 'Golden hour', text: 'luz dorada de golden hour, cálida y rasante', tags: ['general', 'alimentacion', 'hogar-decoracion'] },
  ...
  { id: 'difusa-nublada', label: 'Difusa (día nublado)', text: 'luz difusa de día nublado, sin sombras duras, colores fieles', tags: ['moda', 'alimentacion', 'general'] },
  { id: 'practicas-ambiente', label: 'Luces prácticas de ambiente', text: 'iluminado por fuentes de luz visibles en la propia escena (lámparas, velas)', tags: ['hogar-decoracion', 'general'] },
  { id: 'estudio-tricolor', label: 'Estudio de tres puntos (tricolor)', text: 'esquema de iluminación de tres puntos clásico de estudio publicitario', tags: ['general', 'tecnologia'] },
  { id: 'luz-cenital-suave', label: 'Cenital suave', text: 'luz cenital suave, sombras cortas hacia abajo, sensación de mediodía', tags: ['alimentacion', 'oficina-papeleria'] },
];
